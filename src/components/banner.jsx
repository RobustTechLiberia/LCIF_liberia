...
class Banner extends React.Component {
  render() {
    return (
      <>
        <div
          className="flex flex-wrap bg-[url('/hero.gif')] md:bg-fixed md:w-full object-cover object-center justify-center h-100 md:h-110 bg-gray-400 mx-0 bg-no-repeat bg-cover bg-center"
          id="banner"
        >
